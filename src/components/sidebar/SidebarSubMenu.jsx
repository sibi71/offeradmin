  ...
  return (
    <>
      <li className="relative px-6 py-3" key={route.name}>
        <button
          className="inline-flex items-center justify-between focus:outline-none w-full text-sm font-semibold transition-colors duration-150 hover:text-emerald-500 dark:hover:text-gray-200"
              ...
              <li key={i + 1}>
                {child?.outside ? (
                  <a
                    ...
                    target="_blank"
                    className="flex items-center font-serif py-1 text-sm text-gray-600 hover:text-emerald-500 cursor-pointer"
                    activeStyle={{
                      color: "#f15a29",
                    }}
                    rel="noreferrer"
                  >
                    ...
                    <span className="text-gray-500 hover:text-emerald-500 dark:hover:text-gray-200">
                      {t(`${child.name}`)}
                    </span>
