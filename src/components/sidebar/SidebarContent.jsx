...
import logoColor from "@/assets/img/logo/logo-color.png";
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={logoDark} alt="Offers" width="135" className="pl-6" />
        ) : (
          <img src={logoColor} alt="Offers" width="135" className="pl-6" />
        )}
      </a>
      <ul className="mt-8">
        {sidebar.map((route) =>
          route.routes ? (
            ...
            <li className="relative" key={route.name}>
              <NavLink
                ...
                className="px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-emerald-500 dark:hover:text-gray-200"
